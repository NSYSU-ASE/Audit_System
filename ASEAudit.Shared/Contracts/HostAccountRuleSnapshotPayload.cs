...
///   Hostname                                          → HostName
///   Payload.SystemInfo.Domain                         → UserDomain
///   Payload.SystemInfo.DomainRole                     → DomainRole
///   Payload.AnonymousAccess.RestrictAnonymousSAM      → RestrictAnonymousSAM (BIT)
///   Payload.AnonymousAccess.RestrictAnonymous         → RestrictAnonymous    (BIT)
///   Payload.AnonymousAccess.EveryoneIncludesAnonymous → EveryoneIncludesAnonymous (BIT)
///   (MACAddress 由 Server 端補齊)
/// </summary>
public sealed class HostAccountRuleSnapshotPayload : ScriptPayload<HostAccountRuleSnapshotContent>
{
...
/// <summary>
/// <see cref="HostAccountRuleSnapshotPayload"/> 的實際稽核資料內容。
/// 對應 PowerShell 輸出 JSON 中 <c>Payload</c> 物件。
/// </summary>
public sealed class HostAccountRuleSnapshotContent : PayloadWrapper
{
    /// <summary>
