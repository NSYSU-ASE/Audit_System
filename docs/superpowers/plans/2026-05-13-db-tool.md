...
- [ ] **Step 1：建立 `Dashboard_Area_table_create.sql`**
...
- [ ] **Step 2：建立 `Dashboard_Building_table_create.sql`**
...
- [ ] **Step 3：建立 `Dashboard_Device_table_create.sql`**
...
- [ ] **Step 4：建立 `Dashboard_AuditResult_table_create.sql`**
...
- [ ] **Step 5：建立 `Dashboard_AuditFinding_table_create.sql`**
...
- [ ] **Step 6：使用 SSMS 在乾淨的 sandbox DB 跑一次驗證 5 個腳本**
